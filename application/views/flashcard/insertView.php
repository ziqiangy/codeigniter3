...
<div class="box-father">
    <div class="box-child">
        ...
        <div class="row">
            <div class="col">
                <?php echo anchor("flashcard/displayMultiInsert", "Add Multi", array("class" => "btn btn-primary")); ?>
            </div>
            <div class="col">
                <h3 class="text-center">Add one</h3>
            </div>
            <div class="col">
        ...
        <div class="text-father">
            <div class="text-child">
                ...
                <div class="row">
                    ...
                    <div class="col-3">
                        <?php echo anchor("flashcate/insert", "Add", array("class" => "btn btn-primary")); ?>
